...
Original file is located at
    https://colab.research.google.com/drive/1b4gkBXbHEon7cLD4lMFn6QWhLQhKVAfg
...
#Função para Criar diretórios onde ficaram guardados os arquivos
def Cria_Diretorios():
...
"""##Função para Coletar a lista de links"""
...
def Formata_Palavra(contador, id_index): 
  ...
  #print(lista_link[contador].get('href'))
  return link_item
...
def coleta_info(id_index, contador, startIndex): 
  ...
  for i in range(1000):  
    #Formata_Palavra(contador, id_index)
    ...
    #link = 'https://science.mnhn.fr/institution/mnhn+palavra_formatada+'?listIndex='+id_index+'&listCount=381614'
        ...
        for img in imagem:
          if img.has_attr('src'):
            ...
            if response.status_code == 200:
              with open("Imagens_400px/Img_00"+id+jpg, 'wb') as f:
